...
describe('Robot', function () {
    beforeEach(function () {
        ...
        this.robot = new Robot(null, 'mock-adapter', false, 'TestHubot');
    ...
    describe('Unit Tests', function () {
        ...
        describe('#respond', () => it('registers a new listener using hear', function () {
            sinon_1.default.spy(this.robot, 'hear');
        ...
        describe('#enter', () => it('registers a new listener using listen', function () {
            sinon_1.default.spy(this.robot, 'listen');
        ...
        describe('#receive', function () {
            it('calls all registered listeners', function (done) {
                ...
                sinon_1.default.spy(listener, 'call');
            ...
            it('sends a CatchAllMessage if no listener matches', function (done) {
                ...
                sinon_1.default.spy(this.robot, 'receive');
            ...
            it('stops processing if a listener marks the message as done', function (done) {
                ...
                const listenerSpy = { call: sinon_1.default.spy() };
                this.robot.listeners = [
                    matchingListener,
                    listenerSpy
                ];
            ...
            it('gracefully handles listener uncaughtExceptions (move on to next listener)', function (done) {
                ...
                sinon_1.default.spy(this.robot, 'emit');
        ...
        describe('#loadFile', function () {
            beforeEach(function () {
                this.sandbox = sinon_1.default.sandbox.create();
            });
            afterEach(function () {
            ...
            it('should require the specified file', function () {
                ...
                const script = sinon_1.default.spy(function (robot) { });
            ...
            describe('proper script', function () {
                beforeEach(function () {
                    const module = require('module');
                    this.script = sinon_1.default.spy(function (robot) { });
            ...
            describe('non-Function script', function () {
                ...
                it('logs a warning', function () {
                    sinon_1.default.stub(this.robot.logger, 'warning');
                    this.robot.loadFile('./scripts', 'test-script.js');
        ...
        describe('#send', function () {
            beforeEach(function () {
                sinon_1.default.spy(this.robot.adapter, 'send');
            });
        ...
        describe('#reply', function () {
            beforeEach(function () {
                sinon_1.default.spy(this.robot.adapter, 'reply');
            });
        ...
        describe('#on', function () {
            beforeEach(function () {
                sinon_1.default.spy(this.robot.events, 'on');
            });
        ...
        describe('#emit', function () {
            beforeEach(function () {
                sinon_1.default.spy(this.robot.events, 'emit');
            });
    ...
    describe('Listener Registration', function () {
        describe('#listen', () => it('forwards the matcher, options, and callback to Listener', function () {
            ...
            const matcher = sinon_1.default.spy();
            const options = {};
    ...
    describe('Message Processing', function () {
        ...
        it('does not call the catch-all listener if any listener matched', function (done) {
            ...
            const listenerCallback = sinon_1.default.spy();
            this.robot.hear(/^message123$/, listenerCallback);
            const catchAllCallback = sinon_1.default.spy();
        ...
        describe('Receive Middleware', function () {
            it('fires for all messages, including non-matching ones', function (testDone) {
                const middlewareSpy = sinon_1.default.spy();
                const listenerCallback = sinon_1.default.spy();
                this.robot.hear(/^message123$/, listenerCallback);
            ...
            it('allows editing the message portion of the given response', function (testDone) {
                ...
                this.robot.receiveMiddleware(testMiddlewareA);
                this.robot.receiveMiddleware(testMiddlewareB);
                const testCallback = sinon_1.default.spy();
        ...
        describe('Response Middleware', function () {
            it('executes response middleware in order', function (testDone) {
                let sendSpy;
                this.robot.adapter.send = (sendSpy = sinon_1.default.spy());
            ...
            it('marks plaintext as plaintext', function (testDone) {
                let sendSpy = sinon_1.default.spy();
...
//# sourceMappingURL=robot_test.js.map