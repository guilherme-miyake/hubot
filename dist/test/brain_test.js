...
describe('Brain', function () {
    beforeEach(function () {
        ...
        sinon_1.default.stub(this.mockRobot, 'on').withArgs('running').callsArg(1);
        this.brain = new brain_1.default(this.mockRobot);
    ...
    describe('Unit Tests', function () {
        describe('#mergeData', function () {
            ...
            it('emits a loaded event with the new data', function () {
                sinon_1.default.spy(this.brain, 'emit');
            ...
            it('coerces loaded data into User objects', function () {
                ...
                expect(is_circular_1.default(this.brain)).to.be.false;
            });
        });
        ...
        describe('#resetSaveInterval', () => it('updates the auto-save interval', function () {
            sinon_1.default.spy(this.brain, 'save');
            // default is 5s
        ...
        describe('#close', function () {
            ...
            it('saves before emitting the close event', function () {
                sinon_1.default.spy(this.brain, 'save');
                sinon_1.default.spy(this.brain, 'emit').withArgs('close');
                this.brain.close();
        ...
        describe('#userForId', function () {
            ...
            describe('when there is no matching user ID', function () {
                it('creates a new User', function () {
                    ...
                    expect(newUser).to.be.instanceof(user_1.default);
...
//# sourceMappingURL=brain_test.js.map