...
export default class Adapter extends EventEmitter {
    ...
    constructor(readonly robot: Robot | any = null) {
      super()
    }
    ...
    //
    // Returns nothing.
    emote(envelope: object, ...strings: string[]) {
      // @ts-ignore
    ...
    //
    // Returns nothing.
    send(envelope: object, ...strings: string[]) {
    }
    ...
    //
    // Returns nothing.
    reply(envelope: object, ...strings: string[]) {
    }
    ...
    //
    // Returns nothing.
    topic(envelope: object, ...strings: string[]) {
    }
    ...
    //
    // Returns nothing
    play(envelope: object, ...strings: string[]) {
    }
    ...
    // Returns nothing.
    receive(message: any) {
      this.robot.receive(message, () => null)
    }
    ...
    userForId(id: string, options: any) {
    ...
    usersForRawFuzzyName(fuzzyName: string) {
    ...
    //
    // Returns an Array of User instances matching the fuzzy name.
    usersForFuzzyName(fuzzyName: string) {
